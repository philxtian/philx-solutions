 ...
 * Perfect Circle Sizing, Zero-Crop Logo Framing & Left-to-Right Pill Morph
 */
...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Expanded White Circle Container (180px x 180px for generous whitespace & zero cropping)
        overlay.innerHTML = `
            <div id="intro-morph-capsule" style="position:fixed;top:50%;left:50%;width:180px;height:180px;margin-top:-90px;margin-left:-90px;border-radius:9999px;background:#ffffff;box-shadow:0 25px 60px -15px rgba(0,0,0,0.6);display:flex;align-items:center;justify-content:center;transform:scale(0);transition:transform 0.8s cubic-bezier(0.16, 1, 0.3, 1), top 0.65s cubic-bezier(0.16, 1, 0.3, 1), left 0.65s cubic-bezier(0.16, 1, 0.3, 1), margin 0.65s cubic-bezier(0.16, 1, 0.3, 1), width 0.65s cubic-bezier(0.16, 1, 0.3, 1), height 0.65s cubic-bezier(0.16, 1, 0.3, 1), padding 0.65s cubic-bezier(0.16, 1, 0.3, 1);will-change:transform, top, left, width, height;overflow:hidden;">
                <div id="intro-logo-content" style="opacity:0;transform:scale(0.85);transition:opacity 0.45s ease-out, transform 0.45s cubic-bezier(0.16, 1, 0.3, 1);display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                    <img src="assets/logo-mark-black.png" alt="PHILX Logo" style="height:38px;width:auto;border-radius:8px;">
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        ...
                        // Dock top, left, and height directly to top sticky navbar position
                        ...
                        capsule.style.paddingLeft = '24px';
